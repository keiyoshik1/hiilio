...
function getTable()
{
    ...
    fetch('/utilisateurs/search/'+search.value)
    .then(reponse => reponse.text())
    .then(data => {
        place = document.getElementById("userstable");
...
function getForm(id=null)
{
    if(id!=null)
    {
        ...
        .then(reponse => reponse.text())
        .then(data => {
            place = document.getElementById("user");
            place.innerHTML = data;
        })
        .then(data => {
